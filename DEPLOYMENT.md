...
O health check do Render usa `/actuator/health/readiness`, composto por estado de prontidao, PostgreSQL e Redis. SMTP possui health separado e acompanha `MAIL_ENABLED`; indisponibilidade temporaria de e-mail deve gerar alerta e retentativa operacional, nao reinicio automatico da API.
