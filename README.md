...
- Bloqueio de producao: autenticacao, endpoints dos modulos, autorizacao por objeto, uploads, e-mail, pagamentos, moderacao e backup restaurado ainda precisam ser implementados.
