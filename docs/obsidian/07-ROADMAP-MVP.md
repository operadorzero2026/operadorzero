...
Estado em 2026-07-22: cadastro/login/verificacao/recuperacao/sessao/logout e Google OIDC foram implementados. O e-mail usa Resend por API HTTPS; faltam chave, DNS e homologacao Resend/Google externa, MFA administrativo, central de sessoes, politicas juridicas e testes E2E no staging antes de concluir o marco.
