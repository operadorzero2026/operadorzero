...
export type VenueField = { id:string; name:string; description?:string|null; city:string; stateCode:string; addressLine:string; addressNumber?:string|null; district?:string|null; region?:string|null; openingHours?:string|null; amenities?:string|null; maximumCapacity?:number|null; averagePrice?:number|null; paymentMethods?:string|null; managedByCurrentUser:boolean; version:number }
