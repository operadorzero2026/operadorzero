...
export type OperationParticipant = { operatorId:string; callsign:string; displayName:string; teamName?:string|null; status:string; operationTeamId?:string|null; operationTeamName?:string|null }
...
export type OperationChatMessage={id:string;channelId:string;author:{id:string;callsign:string;displayName:string;teamName?:string|null};parentMessageId?:string|null;body:string;status:string;official:boolean;roleLabel?:string|null;createdAt:string;updatedAt:string;editableByCurrentUser:boolean}
