...
class OperatorServiceTest {
    @Test
    void updateRejectsFutureAirsoftStartDate() {
        ...
        when(repository.findProfile(user.internalId())).thenReturn(Optional.of(new ProfileRow(
            ...
            null, null, null, "LONE_WOLF", null, 0L)));
        ...
        UpdateProfileRequest request = new UpdateProfileRequest("Operator", "Zero", "oldname", null,
            null, null, null, List.of(), "LONE_WOLF", LocalDate.of(2026, 7, 28), 0L);

        assertThatThrownBy(() -> service.update(user, request))
            .isInstanceOfSatisfying(BusinessException.class,
                exception -> org.assertj.core.api.Assertions.assertThat(exception.code()).isEqualTo("INVALID_AIRSOFT_START_DATE"));
    }
    ...
    void updateRejectsUsernameOwnedByAnotherAccount() {
        ...
        UpdateProfileRequest request = new UpdateProfileRequest("Operator", "Zero", "newname", null,
            null, null, null, List.of(), "LONE_WOLF", null, 0L);
