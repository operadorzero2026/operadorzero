...
assert.ok(operationsPage.includes('className="operation-list-row"') && operationsPage.includes('orderedItems.map'))
assert.ok(operationsPage.includes('getOperatorProfile()') && operationsPage.includes('proximity(left) - proximity(right)'))
assert.ok(!operationsPage.includes('className="operation-card-cover"'))
